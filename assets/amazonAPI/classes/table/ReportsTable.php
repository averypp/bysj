...
class WPLA_ReportsTable extends WP_List_Table {
    ...
    function column_details($item){
        ...
        $actions = array(
            ...
            'process_fba_inv_age_report' => sprintf('<a href="?page=%s&action=%s&amazon_report=%s" data-id="%s">%s</a>',$_REQUEST['page'],'process_amazon_report',$item['id'],$item['id'],__('Process Report','wpla')),
