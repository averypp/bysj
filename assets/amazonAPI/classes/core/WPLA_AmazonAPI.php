<?php
// namespace app\assets\AmazonAPI\classes\core;
...
class WPLA_AmazonAPI {
	...
	public function __construct( $store_id = false ) {
        ...
        if ( $store_id ) {
            ...
            $this->setAccessKeyId( $this->account['accesskey_id'] );
    ...
    public function initAPI( $section = false ) {
       ...
       require_once __DIR__ . '/../../includes/amazon/src/MarketplaceWebService/Client.php';
        // require_once __DIR__ . '/../../includes/amazon/src/MarketplaceWebService/Client.php';
        // require_once __DIR__ . '/../../includes/amazon/src/MarketplaceWebServiceSellers/Client.php';
        // require_once __DIR__ . '/../../includes/amazon/src/MarketplaceWebServiceProducts/Client.php';
        // require_once WPLA_PATH . '/includes/amazon/src/FBAOutboundServiceMWS/Client.php';

        // use autoloader to load AmazonAPI classes
       //var_dump(get_include_path());die;
       set_include_path(get_include_path() . PATH_SEPARATOR . '/../../includes/amazon/');
       spl_autoload_register('WPLA_AmazonAPI::autoloadAmazonClasses');
       // spl_autoload_register(array('WPLA_AmazonAPI', 'autoloadAmazonClasses'));
        // configure api
        $config = array (
    ...
    static function autoloadAmazonClasses($className){
        ...
        // var_dump( $includePaths );die;

        foreach($includePaths as $includePath){
              var_dump( $includePaths[2] . DIRECTORY_SEPARATOR . $filePath);die;
