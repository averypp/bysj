<?php
   ...
   define ('AMAZON_SRC', dirname(dirname(__DIR__)));
    ...
    ***********************************************************************/
    // define('AWS_ACCESS_KEY_ID', 'AKIAI777T77AT5ISTVPQ');
    // define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    ***********************************************************************/
    // define('APPLICATION_NAME', 'crosfddfsfsds');
    ...
    * marketplace ID.
    ***********************************************************************/
    // define ('MERCHANT_ID', 'A3JT3LBRIKYRKF');
    ...
    ***********************************************************************/   
   // .:
    set_include_path(get_include_path() . PATH_SEPARATOR . '../.' . PATH_SEPARATOR . AMAZON_SRC);
    // var_dump(get_include_path());die;
	#var_dump(get_include_path() . PATH_SEPARATOR . '../../.');die;
    ...
    ***********************************************************************/   
    ...
    function Mautoload($className)
    {
        ...
        foreach($includePaths as $includePath){
            if(file_exists($includePath . DIRECTORY_SEPARATOR . $filePath)){
                if ($className == 'MarketplaceWebService_Client') {

                    // var_dump($includePaths);die;
                    // die($includePath . DIRECTORY_SEPARATOR . $filePath);
                }
                require_once $filePath;
                return;
            }
