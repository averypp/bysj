<?php
 define ('AMAZON_PRODUCT_SRC', dirname(dirname(__DIR__)));

// var_dump(AMAZON_PRODUCT_SRC);die;
...
*/
    ...
    ***********************************************************************/
    ...
    set_include_path(get_include_path() . PATH_SEPARATOR . '../.' . PATH_SEPARATOR . AMAZON_PRODUCT_SRC);
